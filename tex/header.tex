...
\usepackage{caption}
	...
	\captionsetup[figure]{labelfont=bf, format=plain, labelsep=quad, singlelinecheck=false, textfont=up, font=small}%
        \captionsetup[listing]{font=small,labelfont=bf}
...
\usepackage{minted}
\usepackage{float}
\usepackage[table,xcdraw]{xcolor} % Für farbige Tabellen
\usepackage{amssymb} % Für Häkchen-Symbole
\usepackage{array} % Zusätzliche Tabellenfunktionen
\usepackage{rotating}
