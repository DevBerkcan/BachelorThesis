...
\usepackage[english, breaklinks]{hyperref}
	\hypersetup{colorlinks=false, linkcolor=darkblue, pdfborder={0 0 0}, linktoc=all}
	\urlstyle{same}	
...
% ----- Pakete: Literatur
%------------------------------------------------------------------------------
\usepackage[backend=bibtex, style=ieee, natbib=true]{biblatex} % IEEE-Stil mit Biblatex
\addbibresource{literatur.bib} % Verknüpfung mit der Literaturdatenbank
